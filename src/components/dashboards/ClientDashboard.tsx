    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Report civic issues and track their resolution status.</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {issues.map((issue) => (
          <Card key={issue.issue_id} className="overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow">
